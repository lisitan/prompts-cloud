...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-neutral-950 dark:via-indigo-950 dark:to-purple-950 p-4">
      <div className="w-full max-w-md">
        {/* 统一的顶部标题区域 */}
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent mb-3">
            词匣子
          </h1>
        ...
        {/* 登录表单卡片 */}
        <div className="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl rounded-[2rem] shadow-2xl p-8 border border-neutral-200/50 dark:border-neutral-800/50">
          ...
          <div className="flex gap-2 mb-6 p-1 bg-neutral-100 dark:bg-neutral-800 rounded-[1rem]">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-[0.75rem] font-medium transition-all duration-200 ${isLogin
